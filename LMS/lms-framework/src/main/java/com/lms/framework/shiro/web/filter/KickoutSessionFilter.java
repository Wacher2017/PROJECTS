package com.lms.framework.shiro.web.filter;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.lms.common.api.ResultCode;
import com.lms.common.api.ResultVO;
import com.lms.common.constants.ShiroConstants;
...
public class KickoutSessionFilter extends AccessControlFilter {
    ...
    private boolean isAjaxResponse(ServletRequest request, ServletResponse response) throws IOException {
        ...
        if (ServletUtils.isAjaxRequest(req)) {
            ResultVO resultVO = new ResultVO<>(ResultCode.SYSTEM_LOGIN_EXCEPTION,"您已在别处登录，请您修改密码或重新登录");
            ServletUtils.renderString(res, objectMapper.writeValueAsString(resultVO));
        } else {
