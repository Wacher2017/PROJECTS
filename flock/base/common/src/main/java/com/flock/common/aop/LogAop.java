package com.flock.common.aop;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.flock.common.model.ApiCode;
import com.flock.common.model.ApiResult;
import com.flock.common.utils.AnsiUtil;
import com.flock.common.utils.DateUtil;
...
public class LogAop {
     ...
     * 切点
     */
    private static final String POINTCUT = "execution(public * com.flock.*.controller..*.*(..))";
    /**
     * 默认的请求内容类型,表单提交
     **/
    ...
    public Object doAround(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            map.put("time", DateUtil.getDateTime(new Date()));
